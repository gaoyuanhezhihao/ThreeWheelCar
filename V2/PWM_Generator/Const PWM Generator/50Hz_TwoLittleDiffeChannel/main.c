...
float PWM1_HighLevelPercent = 0.5;
float PWM3_HighLevelPercent = 0.5;
sbit PWM1 	= 	P4^4;                      
sbit PWM3   =   P3^4;
bit pwm1_flag=0;
bit pwm3_flag=0;
...
unsigned int Timer0_itrp_count = 0;
unsigned int Timer1_itrp_count = 0;
#define TIMER0_ITRP_THRESHOLD (2000/50)
#define TIMER1_ITRP_THRESHOLD (2000/25)
//-----------------------------------------------------------------------------
// main() Routine
//-----------------------------------------------------------------------------
...
//   WirelessModule_Init();
   EA = 1;
	...
	TH0_high_pre = (0xFFFF-PWM3_HighLevelCount)>>8;
...
void Timer0_ISR(void) interrupt 1
{
	...
	{
		//Start of High level
			if(Timer0_itrp_count >=  TIMER0_ITRP_THRESHOLD)
			{
				Timer0_itrp_count = 0;
...
//			TL1 = (0xFFFF-PWM3_HighLevelCount);
			...
			if(Timer1_itrp_count > TIMER1_ITRP_THRESHOLD)
			{
				Timer1_itrp_count = 0;
